        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {stats.map((stat, index) => {
            ...
            return (
              <div
                key={index}
                className="text-center p-8 bg-white backdrop-blur-sm rounded-lg border border-white/10 hover:bg-white/10 transition-colors duration-300"
              >
                ...
                <div className="text-lg text-primary/90">{stat.label}</div>
              </div>
            );
          })}
        </div>
